...
/**
 *The Maze class holds together a set amount of cells specified by the user. 
 *It generates and prints maze's based on the dimensions.
 *
...
public class Maze {
    ...
    private int X; // Rey could you comment X and Y ***************************
    private int Y;
    private int DIM; // Dimensions for the Maze

    /**
     * Constructor that generates a 2d array(grid) with cells and sets the position of each cell when a new Maze is made
    ...
    /**
     * Method used to set where to start and where to exit.
    ...
    /**
     * Method that removes the wall between the current cell and its selected neighbor
